                ...
                <div class="row">
                    <div class="col-12 mt-3 d-flex justify-content-center align-items-start">
                        ...
                        <div class="card borderAbout" style="width: 20rem;">
                            <img src="{{ asset('storage/' . $section_4[0]) }}" alt="..." class="card-img-section-4">
                        </div>
                        @endif
        ...
        <div class="col-md-4 col-12">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 mt-3 d-flex justify-content-center align-items-start">
                        <div class="card borderAbout" style="width: 20rem;">
                            <img src="{{ asset('storage/' . $section_4[1]) }}" alt="..." class="card-img-section-4">
                        </div>
                    </div>
                    @endif
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 mt-3 d-flex justify-content-center align-items-start">
                        @if ($section_4)
                        <div class="card borderAbout" style="width: 20rem;">
                            <img src="{{ asset('storage/' . $section_4[2]) }}" alt="..." class="card-img-section-4">
                        </div>
                        @endif
                    </div>
                    <div class="row p-3 detailsContainer d-flex justify-content-center">

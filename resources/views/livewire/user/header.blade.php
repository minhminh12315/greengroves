<div id="header-user-container">
            ...
            <div class="container p-3">
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center gap-3 flex-grow-0">
                        ...
                        <div class="d-lg-none" data-bs-toggle="modal" data-bs-target="#btn-search-mobile">
                            <i class="fa-solid fa-magnifying-glass btn-search-mobile"></i>
                        </div>
    ...
    <div class="modal fade " id="btn-search-mobile" aria-labelledby="exampleModalLabel">
